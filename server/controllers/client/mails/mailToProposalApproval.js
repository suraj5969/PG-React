...
const mailToProposalApproval = async (proposal_no) => {
    ...
    // console.log(process.env.MAIL_USER, process.env.MAIL_PASSWORD, 'mail credentials')
    ...
    transporter.sendMail({
        ...
        to: email,
        subject: `Proposal Approved No. : ${proposal_no}`,
