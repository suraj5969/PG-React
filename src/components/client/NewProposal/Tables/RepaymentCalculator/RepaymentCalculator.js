...
export default function RepaymentCalculator(props) {
  ...
  const { repaymentCalc, setRepaymentCalc, discountTable, viewMode } = props;
  ...
  return (
    <Box sx={{ marginBottom: '1rem', }}>
      ...
      <Box sx={{ width: '100%', maxWidth: '800px', marginTop: '2rem', }}>
        <TableContainer>
          <Table className='subtable'>
            <TableHead>
              <TableRow >
                <StyledHeadCell style={{ textAlign: 'left' }}>Discount Type</StyledHeadCell>
                <StyledHeadCell> Total(without Discount) </StyledHeadCell>
                <StyledHeadCell> Discount Amount </StyledHeadCell>
                <StyledHeadCell> Total(with Discount) </StyledHeadCell>
                <StyledHeadCell> Discount Percent </StyledHeadCell>
              </TableRow>
            </TableHead>
            <TableBody >
              <TableRow >
                ...
                <TableCell align="center">${Number(softwareDis.totalAmount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                <TableCell align="center">${Number(softwareDis.discountAmount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                <TableCell align="center">${Number(softwareDis.amountAfterDiscount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                <TableCell align="center">{Number(softwareDis.discountPercent)}%</TableCell>
              </TableRow>
              ...
              <TableRow >
                ...
                <TableCell align="center">${Number(serviceDis.totalAmount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                <TableCell align="center">${Number(serviceDis.discountAmount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                <TableCell align="center">${Number(serviceDis.amountAfterDiscount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                <TableCell align="center">{Number(serviceDis.discountPercent)}%</TableCell>
              </TableRow>
              ...
              <TableRow >
                ...
                <TableCell align="center">${Number(lexisCareDis.totalAmount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                <TableCell align="center">${Number(lexisCareDis.discountAmount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                <TableCell align="center">${Number(lexisCareDis.amountAfterDiscount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                <TableCell align="center">{Number(lexisCareDis.discountPercent)}%</TableCell>
              </TableRow>
              ...
              <TableRow >
                ...
                <TableCell align="center"><b>${Number(totalDis.totalAmount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</b></TableCell>
                <TableCell align="center"><b>${Number(totalDis.discountAmount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</b></TableCell>
                <TableCell align="center"><b>${Number(totalDis.amountAfterDiscount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</b></TableCell>
                <TableCell align="center"><b>{Number(totalDis.discountPercent)}%</b></TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </TableContainer>
