...
function TrainingMethods(props) {
    ...
    return (
        <Box className={styles.inner}>
            <HeaderBar searchName={searchName} setsearchName={setsearchName} setNavopen={setNavopen} searchText="search training" addBut={false} isDisabled={false} isSearchAppear={true}/>
